...
class KiDbRealm {
    ...
    def authenticate(authToken) {
        ...
        // exception.
        def user = KiUser.findByUsername(username)
        if (!user) {
        ...
        // in the database.
        def account = new SimpleAccount(username, user.passwordHash, "KiDbRealm")
    ...
    def hasRole(principal, roleName) {
        def criteria = KiUserRoleRel.createCriteria()
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def criteria = KiUserPermissionRel.createCriteria()
        ...
        def user = KiUser.findByUsername(principal)
        def roles = KiUserRoleRel.findAllByUser(user)
        ...
        criteria = KiRolePermissionRel.createCriteria()
