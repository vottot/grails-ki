...
target ('default': 'Creates a LDAP Ki realm') {
    ...
    templateFile = "${kiPluginDir}/src/templates/artifacts/KiLdapRealm.groovy"
    if (!new File(templateFile).exists()) {
        Ant.echo("[Ki plugin] Error: src/templates/artifacts/KiLdapRealm.groovy does not exist!")
        return
    }
