...
class FilterAccessControlBuilder {
     ...
     * string that complies with the format supported by Ki's
     ...
     * meaning in the application. See the documentation for Ki's
    ...
    boolean permission(Map args) {
        ...
        def p = new KiBasicPermission(args['type'], args['actions'])
