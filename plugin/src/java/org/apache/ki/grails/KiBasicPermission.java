 ...
 */
public class KiBasicPermission implements Permission {
     ...
     */
    public KiBasicPermission(String target, String actions) {
        this.target = target;
     ...
     */
    public KiBasicPermission(String target, Collection actions) {
        this.target = target;
    ...
    public boolean implies(Permission p) {
        boolean implies = (p instanceof KiBasicPermission);

        if (implies) {
            // Check the target strings are the same.
            KiBasicPermission perm = (KiBasicPermission) p;
            if (this.target == null) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof KiBasicPermission)) {
            return false;
        }

        KiBasicPermission p = (KiBasicPermission) obj;
